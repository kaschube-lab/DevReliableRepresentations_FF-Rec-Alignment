...
key_file = "results_simulation/model_BothOptChange{}_Optimal.npz"
...
for i in range(n_sim_total):
    ...
    for iupdate in tqdm(range(1)):
        ...
        #update rec first to get interpolated eigevectors
        network_updated = suf.update_recurrent(
                              network_naive,
                              data_new,
                              rule='euler2_covoutput',
                              alpha=0.55)  #1.25

        #create new input based on updated rec EV
